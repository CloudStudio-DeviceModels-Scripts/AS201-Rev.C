...
# Parsing + Configuration Script – AS201 - Rev. C

This **Parsing + Configuration** script is designed for the **AS201** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – AS201 Rev. C

Este script de **Parsing + Configuration** está diseñado para el modelo **AS201** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
